...
\documentclass[english, authoryear, draft]{tauthesis}
...
% as the second.
\title{Forecasting investor group behavior using neural networks (working title)}
{Sijoittajajoukkojen käyttäytymisen ennustaminen neuroverkkojen avulla (työotsikko)}
...
% separate line.
\examiner[Examiners]{Prof. Juho Kanniainen \\ Dr. Ke˛stutis Baltakys}

% The finishing date of the thesis (YYYY-MM-DD).
\finishdate{2022}{05}{31}
...
% the thesis.
\facultyname{Faculty of Management and Business}{Johtamisen ja talouden tiedekunta}
\programmename{Master’s Degree Programme in Industrial Engineering and Management
